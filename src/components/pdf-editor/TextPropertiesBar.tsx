...
export default function TextPropertiesBar() {
    ...
    return (
        <div className="w-full bg-white border-b border-slate-200 px-4 py-2 flex flex-wrap items-center justify-center gap-4 md:gap-6 animate-slideDown shadow-sm">
            ...
            <div className="flex items-center gap-2">
                ...
                <select 
                    ...
                    className="h-8 text-sm border-slate-200 rounded-md text-slate-700 focus:ring-cyan-500 bg-slate-50 min-w-[140px]"
                >
                    {FONTS.map(f => (
            ...
            <div className="flex items-center gap-2 bg-slate-50 rounded-md border border-slate-200 p-0.5">
                <button 
                    ...
                    className="w-8 h-8 flex items-center justify-center hover:bg-white hover:shadow-sm rounded text-slate-600 active:scale-95 transition-all"
                >
                    <Minus size={14} />
                </button>
