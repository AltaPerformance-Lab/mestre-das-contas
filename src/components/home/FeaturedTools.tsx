    ...
    <section className="px-4 -mt-24 relative z-20 mb-16">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-800 p-1 overflow-hidden relative group h-full">
              ...
              <div className="bg-white dark:bg-slate-900/95 backdrop-blur-xl rounded-[20px] p-6 h-full flex flex-col justify-between relative z-10">
                  <div>
                      <div className="flex items-center gap-2 mb-4">
                          <div className="bg-indigo-100 dark:bg-indigo-900/30 p-2 rounded-lg text-indigo-600 dark:text-indigo-400">
                              <QrCode size={24}/>
                          </div>
                          <span className="text-indigo-600 dark:text-indigo-400 font-bold uppercase text-[10px] tracking-widest bg-indigo-50 dark:bg-indigo-900/20 px-2 py-1 rounded border border-indigo-100 dark:border-indigo-800">Nova Ferramenta</span>
                      </div>
                      <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-2">Gerador de QR Code</h2>
