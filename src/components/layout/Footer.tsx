...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-slate-200 pt-16 pb-8 mt-auto z-10 relative print:hidden">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-sm text-pretty">
          ...
          <div className="lg:col-span-3">
            <h3 className="font-bold text-slate-900 mb-5 text-xs uppercase tracking-widest">Mais Acessadas</h3>
            <ul className="space-y-3 text-sm text-slate-600 font-medium">
              ...
              <li><Link href="/ferramentas/gerador-qr-code" className="hover:text-blue-600 hover:translate-x-1 transition-all inline-flex items-center gap-2"><QrCode size={14} className="text-blue-500"/> Gerador de QR Code</Link></li>
          ...
          {/* COLUNA 3: Categorias */}
          <div className="lg:col-span-3">
            <h3 className="font-bold text-slate-900 mb-5 text-xs uppercase tracking-widest">Explore</h3>
            <ul className="space-y-3 text-sm text-slate-600 font-medium">
              ...
              <li>
                <Link href="/financeiro/reforma-tributaria" className="text-emerald-700 font-bold hover:text-emerald-800 hover:translate-x-1 transition-all inline-flex items-center gap-2">
                  Reforma Tributária <span className="text-[9px] bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded-full uppercase tracking-wide border border-emerald-200">Novo</span>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            <h3 className="font-bold text-slate-900 mb-5 text-xs uppercase tracking-widest">Institucional</h3>
            <ul className="space-y-3 text-sm text-slate-600 font-medium">
              <li>
              ...
              <li>
                <Link href="/politica-privacidade" className="hover:text-blue-600 transition-colors flex items-center gap-2">
                  <Shield size={14} className="text-slate-400" /> Privacidade
                </Link>
              </li>
              <li>
                <Link href="/politica-cookies" className="hover:text-blue-600 transition-colors flex items-center gap-2">
                  <Cookie size={14} className="text-slate-400" /> Cookies
                </Link>
              </li>
              <li>
                <Link href="/termos-de-uso" className="hover:text-blue-600 transition-colors flex items-center gap-2">
                  <FileText size={14} className="text-slate-400" /> Termos de Uso
                </Link>
              </li>
              <li>
                <Link href="/fale-conosco" className="hover:text-blue-600 transition-colors flex items-center gap-2">
