...
export default function PDFEditorPage() {
  return (
    <article className="w-full min-h-screen bg-slate-50 pb-20 font-sans">
      ...
      <div className="w-full flex-grow min-h-[600px] h-[80vh] bg-slate-100 relative shadow-inner border-b border-slate-200">
         <PDFEditorWrapper />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        ...
        {/* ANÚNCIO TOPO */}
        <div className="w-full flex justify-center bg-slate-100 rounded-xl p-4 min-h-[100px] border border-transparent">
             <LazyAdUnit slot="pdf_top" format="horizontal" variant="agency" />
        </div>
        ...
        <section className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-1 transition-transform duration-300">
                <div className="bg-violet-50 w-14 h-14 rounded-2xl flex items-center justify-center text-violet-600 mb-6 shadow-sm">
                    <ShieldCheck size={32} />
                </div>
                <h3 className="font-bold text-xl text-slate-900 mb-3">Privacidade Garantida</h3>
                ...
                <div className="mt-4 inline-flex items-center gap-1 text-xs font-bold text-violet-600 bg-violet-50 px-3 py-1 rounded-full">
                    <Lock size={12}/> Dados Criptografados Localmente
                </div>
            </div>
            
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-1 transition-transform duration-300">
                <div className="bg-emerald-50 w-14 h-14 rounded-2xl flex items-center justify-center text-emerald-600 mb-6 shadow-sm">
                    <Zap size={32} />
                </div>
                <h3 className="font-bold text-xl text-slate-900 mb-3">Instantâneo e Leve</h3>
                <p className="text-slate-600 leading-relaxed text-sm">
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 hover:-translate-y-1 transition-transform duration-300">
                <div className="bg-amber-50 w-14 h-14 rounded-2xl flex items-center justify-center text-amber-600 mb-6 shadow-sm">
                    <PenTool size={32} />
                </div>
                <h3 className="font-bold text-xl text-slate-900 mb-3">Tudo em Um Lugar</h3>
                <p className="text-slate-600 leading-relaxed text-sm">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
            ...
            {/* Main Content */}
            <div className="lg:col-span-2 prose prose-slate prose-lg max-w-none bg-white p-8 md:p-12 rounded-3xl border border-slate-100 shadow-sm">
                ...
                <h3 className="text-2xl font-bold text-slate-800 mt-10 mb-4 flex items-center gap-2">
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border-l-4 border-violet-500 mt-10 not-prose">
                    <h4 className="font-bold text-slate-900 text-lg mb-2 flex items-center gap-2">
                        <Monitor size={20} className="text-violet-600"/> Dica para Profissionais
                    </h4>
            ...
            <div className="space-y-8">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    <div className="flex items-center gap-1 text-amber-400 mb-2">
                        ...
                        <Star className="fill-current" size={20} />
                        <Star className="fill-current" size={20} />
                        <span className="text-slate-800 font-bold ml-2 text-lg">4.9/5</span>
                    </div>
                    <p className="text-slate-600 text-sm mb-4">Baseado em <strong>2.450 avaliações</strong> de usuários reais.</p>
                    <div className="border-t border-slate-100 pt-4">
                        <p className="italic text-slate-500 text-sm">"Incrível! Consegui juntar os documentos da minha rescisão e assinar tudo pelo celular em segundos."</p>
                        <div className="flex items-center gap-3 mt-3">
                            <div className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-xs font-bold text-slate-600">RC</div>
                            <div>
                                <p className="text-xs font-bold text-slate-900">Ricardo C.</p>
                                <p className="text-[10px] text-slate-400">Contador, SP</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Vertical Ad */}
                <div className="w-full flex justify-center bg-slate-50 border border-slate-200 rounded-xl min-h-[300px]">
        ...
        <section id="faq" className="max-w-4xl mx-auto">
             <h2 className="text-3xl font-bold text-slate-900 mb-8 flex items-center gap-3">
                <HelpCircle className="text-violet-600" /> Perguntas Frequentes
             </h2>
             <Accordion type="single" collapsible className="w-full space-y-4">
                {faqList.map((item, idx) => (
                    <AccordionItem key={idx} value={`item-${idx}`} className="bg-white border border-slate-200 rounded-2xl px-6 data-[state=open]:ring-2 data-[state=open]:ring-violet-100 data-[state=open]:border-violet-200 transition-all">
                        <AccordionTrigger className="text-left font-bold text-slate-700 hover:text-violet-700 hover:no-underline py-5 text-lg">
                            {item.q}
                        </AccordionTrigger>
        ...
        <div className="border-t border-slate-200 pt-10">
            <h3 className="text-center font-bold text-slate-400 text-sm uppercase tracking-widest mb-8">Descubra mais ferramentas</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Link href="/ferramentas/conversor-imagem" className="bg-white p-4 rounded-xl border border-slate-200 hover:border-blue-400 hover:-translate-y-1 transition-all text-center group">
                    <div className="mx-auto bg-blue-50 w-10 h-10 rounded-lg flex items-center justify-center text-blue-600 mb-2 group-hover:scale-110 transition-transform"><Layers size={20}/></div>
                    <span className="font-bold text-slate-700 text-sm block">Conversor Imagem</span>
                </Link>
                <Link href="/ferramentas/gerador-link-whatsapp" className="bg-white p-4 rounded-xl border border-slate-200 hover:border-green-400 hover:-translate-y-1 transition-all text-center group">
                    <div className="mx-auto bg-green-50 w-10 h-10 rounded-lg flex items-center justify-center text-green-600 mb-2 group-hover:scale-110 transition-transform"><Share2 size={20}/></div>
                    <span className="font-bold text-slate-700 text-sm block">Link WhatsApp</span>
                </Link>
                <Link href="/ferramentas/gerador-recibo" className="bg-white p-4 rounded-xl border border-slate-200 hover:border-amber-400 hover:-translate-y-1 transition-all text-center group">
                    <div className="mx-auto bg-amber-50 w-10 h-10 rounded-lg flex items-center justify-center text-amber-600 mb-2 group-hover:scale-110 transition-transform"><FileText size={20}/></div>
                    <span className="font-bold text-slate-700 text-sm block">Gerador Recibo</span>
                </Link>
                <Link href="/trabalhista/rescisao" className="bg-white p-4 rounded-xl border border-slate-200 hover:border-red-400 hover:-translate-y-1 transition-all text-center group">
                    <div className="mx-auto bg-red-50 w-10 h-10 rounded-lg flex items-center justify-center text-red-600 mb-2 group-hover:scale-110 transition-transform"><History size={20}/></div>
                    <span className="font-bold text-slate-700 text-sm block">Cálculo Rescisão</span>
                </Link>
            </div>
        </div>
