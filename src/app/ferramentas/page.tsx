...
export const metadata: Metadata = {
  ...
  description: "Aumente sua produtividade com nossas ferramentas digitais gratuitas. Gere QR Codes personalizados, converta arquivos e muito mais. Simples, rápido e seguro.",
  keywords: [
  ...
  openGraph: {
    ...
    locale: "pt_BR",
    type: "website",
    images: [{ url: "https://mestredascontas.com.br/opengraph-image", width: 1200, height: 630, alt: "Ferramentas - Mestre das Contas", }],
  },
};
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/ferramentas/gerador-qr-code" className="group relative overflow-hidden bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">Gerador de QR Code</h2>
              <p className="text-slate-600 mb-6 leading-relaxed flex-1 text-sm">
                Crie QR Codes personalizados para links, PIX, Wi-Fi e contatos. Baixe em alta qualidade (PNG/SVG) gratuitamente.
              </p>
          ...
          <div className="group relative overflow-hidden bg-slate-50 rounded-3xl border border-slate-200 opacity-80 h-full flex flex-col cursor-not-allowed">
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col grayscale opacity-60">
              ...
              <h2 className="text-xl font-bold text-slate-700 mb-3">Gerador de Senhas</h2>
              <p className="text-slate-500 mb-6 leading-relaxed flex-1 text-sm">
                Crie senhas fortes e seguras aleatoriamente para proteger suas contas contra invasões.
              </p>
            </div>
          </div>

          {/* 3. EM BREVE: Conversor JSON */}
          <div className="group relative overflow-hidden bg-slate-50 rounded-3xl border border-slate-200 opacity-80 h-full flex flex-col cursor-not-allowed">
            <div className="absolute top-4 right-4">
                <span className="bg-slate-200 text-slate-500 text-[10px] font-bold px-2 py-1 rounded-full uppercase tracking-wide border border-slate-300">Em Breve</span>
            </div>
            <div className="p-6 md:p-8 flex-1 flex flex-col grayscale opacity-60">
              ...
              <p className="text-slate-500 mb-6 leading-relaxed flex-1 text-sm">
                Ferramenta para desenvolvedores: valide, formate e minifique seus arquivos JSON.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 my-10 not-prose">
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
                  <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
                      <MousePointer2 className="text-blue-600"/> 100% Online e Gratuito
                  </h3>
                  <p className="text-slate-600 text-sm leading-relaxed">
                      Esqueça downloads suspeitos. Nossas ferramentas utilizam o poder do seu navegador (tecnologia <em>Client-Side</em>) para processar dados instantaneamente.
                  </p>
              </div>
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
                  <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
                      <Smartphone className="text-indigo-600"/> Responsivo e Rápido
                  </h3>
                  <p className="text-slate-600 text-sm leading-relaxed">
                      Seja no celular, tablet ou computador, nossas interfaces são projetadas para carregar em milissegundos e funcionar perfeitamente em qualquer tela.
                  </p>
              </div>
          </div>

          {/* ROADMAP */}
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-8 rounded-3xl text-white relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2 relative z-10">
                  <Wrench size={24} className="text-amber-400"/> O que vem por aí?
              </h3>
              ...
              <ul className="grid sm:grid-cols-2 gap-3 relative z-10 text-sm font-medium">
                  <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-emerald-400"/> Conversor de Imagens (WebP/PNG)</li>
                  <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-emerald-400"/> Gerador de Senhas Fortes</li>
                  <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-emerald-400"/> Teste de Velocidade de Digitação</li>
                  <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-emerald-400"/> Contador de Caracteres</li>
              </ul>
          </div>
