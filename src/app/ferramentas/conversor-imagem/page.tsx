...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "pt_BR",
    type: "website",
    images: [{ url: "/og-converter.png", width: 1200, height: 630, alt: "Conversor de Imagens Seguro" }],
  },
    ...
    <article className="w-full max-w-full overflow-hidden font-sans">
      ...
      <div className="flex flex-col gap-8 px-4 sm:px-6 pb-12 max-w-7xl mx-auto">
        ...
        <div className="w-full max-w-5xl mx-auto overflow-hidden flex justify-center bg-slate-50/50 rounded-lg border border-dashed border-slate-200/50 print:hidden min-h-[100px]">
           <AdUnit slot="img_top" format="horizontal" variant="agency" />
        </div>
        ...
        <div className="w-full max-w-4xl mx-auto flex justify-center my-6 print:hidden min-h-[250px]">
            <AdUnit slot="img_mid" format="auto" />
        </div>
        ...
        <div className="prose prose-slate prose-sm md:prose-lg max-w-4xl mx-auto bg-white p-6 md:p-12 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 overflow-hidden w-full print:hidden">
            ...
            <div className="bg-green-50 p-6 rounded-2xl border border-green-200 my-8 not-prose shadow-sm">
                ...
                <ul className="grid sm:grid-cols-2 gap-3 text-sm text-green-800 font-medium">
                    <li className="flex gap-2"><CheckCircle2 className="text-green-600"/> Zero Upload (Instantâneo)</li>
                    <li className="flex gap-2"><CheckCircle2 className="text-green-600"/> Privacidade Absoluta</li>
                    <li className="flex gap-2"><CheckCircle2 className="text-green-600"/> Sem limite de tamanho</li>
                    <li className="flex gap-2"><CheckCircle2 className="text-green-600"/> Funciona Offline</li>
                </ul>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 not-prose mb-10">
                <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 hover:border-blue-300 transition-colors">
                    <h4 className="font-bold text-slate-900 mb-2 flex items-center gap-2"><Zap size={18} className="text-blue-500"/> AVIF & WebP</h4>
                ...
                <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 hover:border-orange-300 transition-colors">
                    <h4 className="font-bold text-slate-900 mb-2 flex items-center gap-2"><FileImage size={18} className="text-orange-500"/> JPG / JPEG</h4>
                    <p className="text-xs text-slate-600 leading-relaxed">
                        O padrão universal. Abre em qualquer lugar, de TVs antigas a celulares. Ideal para fotos de câmera e impressão.
                    </p>
                </div>
                <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 hover:border-purple-300 transition-colors">
                    <h4 className="font-bold text-slate-900 mb-2 flex items-center gap-2"><Layers size={18} className="text-purple-500"/> PNG</h4>
                    <p className="text-xs text-slate-600 leading-relaxed">
                ...
                <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 hover:border-green-300 transition-colors">
                    <h4 className="font-bold text-slate-900 mb-2 flex items-center gap-2"><FileCode size={18} className="text-green-500"/> ICO</h4>
                    <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="bg-slate-900 text-white p-6 rounded-xl my-6 not-prose shadow-lg">
            ...
            <div className="mt-16 not-prose" id="faq">
                ...
                <div className="space-y-4">
                  {faqList.map((item, idx) => (
                      <details key={idx} className="group bg-slate-50 p-5 rounded-2xl border border-slate-200 shadow-sm cursor-pointer open:bg-white open:ring-2 open:ring-slate-100 transition-all duration-300">
                          <summary className="font-bold text-slate-800 list-none flex justify-between items-center text-base select-none">
                              <span className="leading-snug">{item.p}</span>
                              <span className="text-slate-400 group-open:rotate-180 transition-transform ml-2 shrink-0">▼</span>
                          </summary>
                          <p className="mt-4 text-slate-600 leading-relaxed border-t border-slate-100 pt-4 text-sm animate-in fade-in">
                              {item.r}
                          </p>
                      </details>
                  ))}
            ...
            <div className="mt-16 pt-8 border-t border-slate-200 print:hidden not-prose">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <Link href="/financeiro/reforma-tributaria" className="flex flex-col p-5 bg-white border border-slate-200 rounded-xl hover:border-emerald-400 hover:shadow-lg transition-all group">
                      <div className="bg-emerald-50 w-10 h-10 rounded-lg flex items-center justify-center mb-3 text-emerald-600 shadow-sm group-hover:scale-110 transition-transform"><FileText size={20}/></div>
                      <span className="font-bold text-slate-800 text-lg">Reforma Tributária</span>
                      <span className="text-sm text-slate-500 mt-1">Simulador 2026</span>
                  </Link>
                </div>
            </div>
        ...
        <div className="w-full flex justify-center mt-8 min-h-[250px]">
            <AdUnit slot="img_bottom" format="horizontal" variant="software" />
        </div>
