  ...
  return (
    <article className="max-w-4xl mx-auto py-12 px-4 md:px-8">
      ...
      <div className="text-center mb-12 border-b border-slate-200 dark:border-slate-800 pb-8">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-2xl mb-6 shadow-sm">
           <Shield size={32} />
        </div>
      ...
      <div className="prose prose-slate dark:prose-invert prose-lg max-w-none text-slate-800 dark:text-slate-200 leading-relaxed prose-headings:text-slate-900 dark:prose-headings:text-slate-50 prose-p:text-slate-800 dark:prose-p:text-slate-200 prose-strong:text-slate-900 dark:prose-strong:text-slate-100 prose-li:text-slate-800 dark:prose-li:text-slate-200">
        ...
        <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 my-8 not-prose">
            <h3 className="flex items-center gap-2 text-xl font-bold text-slate-900 dark:text-slate-50 mb-3">
                <Server className="text-blue-600 dark:text-blue-400" size={24}/> 1. Segurança dos seus Cálculos
            </h3>
            <p className="text-slate-800 dark:text-slate-200 text-sm md:text-base">
                Queremos deixar claro: <strong>Nós não armazenamos os valores, arquivos ou documentos que você envia/digita.</strong>
            </p>
            <ul className="mt-3 space-y-2 text-sm text-slate-800 dark:text-slate-200">
                <li className="flex gap-2"><CheckIcon/> Os cálculos (salário, férias) e ferramentas (editor PDF, geradores) funcionam 100% no seu navegador (Client-Side).</li>
        ...
        <h3 className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold mt-10">
            <Eye className="text-indigo-600 dark:text-indigo-400" size={24}/> 2. Coleta de Dados de Navegação
        </h3>
        <p>
        ...
        <h3 className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold mt-10">
            <Cookie className="text-amber-600 dark:text-amber-400" size={24}/> 3. Cookies e Publicidade (Google AdSense)
        </h3>
        <p>
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 p-5 rounded-xl border border-amber-100 dark:border-amber-900/30 text-sm text-amber-900 dark:text-amber-100 not-prose">
            ...
            <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Você pode desativar a publicidade personalizada acessando as <a href="https://www.google.com/settings/ads" target="_blank" rel="nofollow noreferrer" className="underline hover:text-amber-700 dark:hover:text-amber-300">Configurações de Anúncios</a>.</li>
            </ul>
        </div>

        <h3 className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold mt-10">
            <Lock className="text-emerald-600 dark:text-emerald-400" size={24}/> 4. Seus Direitos (LGPD)
        </h3>
        <p>
        ...
        <h3 className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold mt-10">
            <FileText className="text-slate-600 dark:text-slate-400" size={24}/> 5. Alterações nesta Política
        </h3>
        <p>
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 mt-12 pt-8 text-center not-prose">
            <p className="text-slate-600 dark:text-slate-400 font-medium mb-4">Ainda tem dúvidas sobre nossa política?</p>
            <Link 
                href="/fale-conosco" 
