  ...
  return (
    <article className="max-w-4xl mx-auto py-12 px-4 md:px-8">
      ...
      <div className="text-center mb-12 border-b border-slate-200 dark:border-slate-800 pb-8">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 rounded-2xl mb-6 shadow-sm">
           <Cookie size={32} />
        </div>
      ...
      <div className="prose prose-slate prose-lg max-w-none text-slate-800 dark:text-slate-200 leading-relaxed prose-headings:text-slate-900 dark:prose-headings:text-slate-50 prose-p:text-slate-800 dark:prose-p:text-slate-200 prose-strong:text-slate-900 dark:prose-strong:text-slate-100 prose-li:text-slate-800 dark:prose-li:text-slate-200">
        ...
        <h3 className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold mt-8">
            <Info className="text-blue-600 dark:text-blue-400" size={24}/> O que são Cookies?
        </h3>
        <p>
        ...
        <h3 className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold mt-8">
            <ShieldCheck className="text-emerald-600 dark:text-emerald-400" size={24}/> Como usamos os cookies?
        </h3>
        ...
        <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 my-8 not-prose">
            <h4 className="font-bold text-slate-900 dark:text-slate-50 mb-2">Cookie DART do Google</h4>
            ...
            <p className="text-sm text-slate-800 dark:text-slate-300">
                Você pode optar por não usar o cookie DART visitando a <a href="https://policies.google.com/technologies/ads" target="_blank" rel="nofollow noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Política de privacidade da rede de conteúdo e anúncios do Google</a>.
            </p>
        </div>

        <h3 className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold mt-8">
            <Settings className="text-slate-600 dark:text-slate-400" size={24}/> Como controlar os cookies?
        </h3>
        <p>
