...
export const alt = 'Calculadora de Calorias | Mestre das Contas'
...
export default async function Image() {
  return new ImageResponse(
    (
      <div
        style={{
          background: 'linear-gradient(to bottom right, #881337, #be123c)',
          width: '100%',
          height: '100%',
          display: 'flex',
      ...
      >
        ...
        <div style={{ fontSize: 32, color: '#fecdd3', marginTop: '30px', textAlign: 'center', maxWidth: '80%' }}>
            Descubra quantas calorias você queima por dia (TMB) e planeje sua dieta ideal.
        </div>
      </div>
    ),
    { ...size }
