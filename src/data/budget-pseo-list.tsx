...
export const budgetCases: BudgetPSeoCase[] = [
    ...
    },
    {
        ...
        articleContent: (
            <div className="space-y-8">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-6">Dicas para Eletricistas Autônomos</h3>
                <p className="text-slate-700 dark:text-slate-300">
    ...
    },
    {
        ...
        articleContent: (
            <div className="space-y-6">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Cobrar por m² ou Empreitada Fechada?</h3>
                <p className="text-slate-700 dark:text-slate-300">
    ...
    },
    {
        ...
        articleContent: (
            <div className="space-y-6">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Como cobrar mensalidade (Fee Mensal)?</h3>
                <p className="text-slate-700 dark:text-slate-300">
    ...
    },
    {
        ...
        articleContent: (
            <div className="space-y-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Ganhe dinheiro com PMOC</h3>
                <p className="text-slate-700 dark:text-slate-300">
    ...
    },
    {
        ...
        articleContent: (
            <div className="space-y-6">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Como cobrar por fotografia?</h3>
                <p className="text-slate-700 dark:text-slate-300">
    ...
    },
    {
        ...
        articleContent: (
            <div className="space-y-6">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">O segredo do orçamento de serralheria</h3>
                <p className="text-slate-700 dark:text-slate-300">
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                    <strong className="text-slate-900 dark:text-white">Detalhe o acabamento:</strong> 
                    <span className="text-slate-700 dark:text-slate-300 ml-1">O cliente precisa saber se o portão vai pintado ou no ferro cru. A pintura dá trabalho e gasta muito material (zarcão, esmalte, solvente). Não dê isso de graça.</span>
                </div>
            </div>
        )
    },
    {
        ...
        articleContent: (
            <div className="space-y-6">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Transparência na Oficina</h3>
                <p className="text-slate-700 dark:text-slate-300">
    ...
    },
    {
        ...
        articleContent: (
             <div className="space-y-6">
                ...
                <div className="bg-purple-50 dark:bg-purple-950/30 p-4 rounded-xl border border-purple-200 dark:border-purple-900">
                    <h4 className="font-bold text-purple-900 dark:text-purple-200">O que valoriza seu serviço:</h4>
                    <ul className="text-sm text-purple-800 dark:text-purple-300 list-disc pl-4 mt-2">
